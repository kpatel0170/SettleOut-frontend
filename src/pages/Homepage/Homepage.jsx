  ...
  <div className="container">
    ...
    <div className="site">
      ...
      <div className="site__box-link">
        <a className="btn btn--width" href="/Pricing">Choose an Agent</a>
        <a className="btn btn--revert btn--width" href="/Contact">Contact</a>
      </div>
  ...
  <div className="container">
    <div className="row">
      <div className="col-md-12">
        ...
        <a href="#/Agent" className="btn btn--white btn--width">Become An Agent</a>
      </div>
    </div>
  </div>
